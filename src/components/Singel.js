...
function Singel() {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/getsingleproduct/${val._id}`)
      ...
      <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={data.product_image} />
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              <h1 class="text-white text-3xl title-font font-medium mb-1">{data.product_name}</h1>
              <div class="flex mb-4">
