    ...
    return (
        <>
            ...
            <div class="py-16 bg-black">
                <div class="container m-auto px-6 space-y-8 text-gray-500 md:px-12 lg:px-20 overflow-hidden">
                    <div class="justify-center text-center gap-6 md:text-left md:flex lg:items-center  lg:gap-16 overflow-hidden ">
                        <div class="order-last mb-6 space-y-6 md:mb-0 md:w-6/12 lg:w-6/12">
                            <h1 class="text-4xl text-white font-bold md:text-5xl">Buy now and benefit up to <span class="text-blue-500">30% off</span></h1>
                        ...
                        <div class="grid grid-cols-5 grid-rows-4 gap-4 md:w-5/12 lg:w-6/12">
                            ...
                            <img src={require('../images/16.jpg')} class="w-full h-full object-cover object-top rounded-xl" width="640" height="427" alt="shoes" loading="lazy"/>
                            </div>
                            <div class="col-span-2 row-span-2">
                            <img src={require('../images/5.jpg')} class="w-full h-full object-cover object-top rounded-xl" width="640" height="427" alt="shoes" loading="lazy"/>
                            </div>
                            <div class="col-span-3 row-span-3">
                                <img src={require('../images/8.jpg')} class="w-full h-full object-cover object-top rounded-xl" width="640" height="427" alt="shoes" loading="lazy"/>
                            </div>
                        </div>
                    </div>
                </div>
